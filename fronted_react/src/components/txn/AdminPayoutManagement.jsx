        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <button 
              disabled={page <= 1} 
              onClick={() => onPrev()} 
              className="inline-flex items-center justify-center gap-1.5 px-3 h-8 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 disabled:opacity-40 disabled:cursor-not-allowed transition-colors text-[13px]"
            >
              Prev
            </button>
            <span className="px-2 text-[13px] text-gray-500 dark:text-gray-400">{page} / {lastPage}</span>
            <button
    ...
    <div className="space-y-5">
      <div className="max-w-7xl mx-auto space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">Payout Management</h1>
            <p className="text-[13px] text-gray-500 dark:text-gray-400 mt-0.5">Manage display accounts and top-up approvals</p>
          </div>
          <button
            onClick={refreshAll}
            disabled={loading}
            className="inline-flex items-center h-8 px-3 rounded-md text-[13px] font-medium bg-indigo-600 hover:bg-indigo-700 text-white disabled:opacity-50"
          >
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between mb-6">
            ...
            {formMode === "edit" && (
              <button
                onClick={resetForm}
                className="inline-flex items-center justify-center gap-1.5 px-4 h-8 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[13px]"
              >
                Cancel Edit
              </button>
            )}
          ...
          <form onSubmit={submitDisplayAccount} className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
              ...
              />
              <div>
                <label className="text-[13px] font-medium text-gray-700 dark:text-gray-300">Validated Account</label>
            ...
            <div className="flex justify-end gap-3 pt-4">
              <button 
                type="submit" 
                className={`inline-flex items-center h-8 px-3 rounded-md text-[13px] font-medium text-white ${formMode === "create" ? "bg-indigo-600 hover:bg-indigo-700" : "bg-green-600 hover:bg-green-700"}`}
              >
                {formMode === "create" ? (
                  <>
                    <svg className="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
          <div className="px-4 py-2.5 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Display Accounts</h2>
            ...
            {loading ? (
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">ID</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Account Holder</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Account Number</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">IFSC</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Bank</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Status</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Actions</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                  {displayAccounts.map((a) => (
                    <tr key={a.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] font-medium font-mono text-gray-600 dark:text-gray-400">#{a.id}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] text-gray-900 dark:text-gray-100">{a.account_holder_name}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] font-mono text-gray-700 dark:text-gray-300">{a.beneficiary_account_number}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] text-gray-700 dark:text-gray-300">{a.beneficiary_ifsc}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] text-gray-700 dark:text-gray-300">{a.beneficiary_bank_name}</td>
                      ...
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px]">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-1.5 px-3 h-8 rounded-md border border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[13px] font-medium"
                          >
                            Edit
                          </button>
                          <button
                            onClick={() => deleteAccount(a.id)}
                            className="inline-flex items-center justify-center gap-1.5 px-3 h-8 rounded-md border border-red-300 text-red-700 hover:bg-red-50 transition-colors text-[13px] font-medium"
                          >
                            Delete
                          </button>
                        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
          <div className="px-4 py-2.5 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Pending Top-ups</h2>
          ...
          {/* Filters */}
          <div className="px-4 py-2.5 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
            ...
            {pendingTopups.length === 0 ? (
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">ID</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">User</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Amount</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Beneficiary</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">UTR/Txn</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Receipt</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Submitted</th>
                    <th className="px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 text-left">Actions</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                  {pendingTopups.map((t) => (
                    <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] font-medium font-mono text-gray-600 dark:text-gray-400">#{t.id}</td>
                      ...
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px]">
                        <span className="font-mono font-medium tabular-nums text-gray-900 dark:text-gray-100">₹{Number(t.amount).toLocaleString("en-IN")}</span>
                      </td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] text-gray-700 dark:text-gray-300">{t.beneficiary_account_number}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] font-mono text-gray-700 dark:text-gray-300">{t.utr_or_txn_id || "-"}</td>
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px]">
                        {t.receipt_url ? (
                          <button
                            onClick={() => {
                            ...
                            className="px-3 h-8 rounded-md border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[13px] font-medium flex items-center gap-1"
                          >
                      ...
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px] text-gray-600">
                      ...
                      <td className="px-4 py-2.5 whitespace-nowrap text-[13px]">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 h-8 rounded-md bg-green-600 text-white hover:bg-green-600 transition-colors text-[13px] font-medium flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            </svg>
                          ...
                          <button
                            ...
                            disabled={actionLoading}
                            className="px-3 h-8 rounded-md border border-red-300 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-[13px] font-medium flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
          <div className="px-4 py-2.5 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Verified Top-ups</h2>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 !m-0 p-4">
            <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-5 w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100">Receipt — Topup #{selectedTopup.id}</h3>
              ...
              <div className="p-6">
                ...
                <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-900">
                  ...
                  <div className="flex justify-center items-center min-h-[300px] bg-white dark:bg-gray-900 rounded border">
                      ...
                      selectedTopup.receipt_url.match(/\.(jpg|jpeg|png|gif)$/i) ? (
                        ...
                        <div className="p-6 text-center">
                          ...
                          <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="inline-flex items-center h-8 px-3 rounded-md text-[13px] font-medium bg-indigo-600 hover:bg-indigo-700 text-white"
                          >
